...
<p>1.1.1 Наименование: Процесс записи на услугу</p>
...
<p>1.2.1 Наименование: Разработка веб-сайта стоматологии с возможностью онлайн записи.</p>
<p>1.2.2 Цель (изменяемый критерий SMART цели системы): Увеличение скорости записи на услугу, автоматизация процесса.</p>
...
<tr>
<td>S (конкретность)</td>
<td align="center">Набор готовых структурированных записей в базе данных</td>
<td align="right">+ или -</td>
</tr>
<tr>
<td>М (измеримость)</td>
<td align="center">Корректность структуры записей в базе данных и их количество</td>
<td align="right">+ или -</td>
</tr>
<tr>
<td>А (достижимость)</td>
<td align="center">Команда проекта/Chuikom</td>
<td align="right">+ или -</td>
</tr>
<tr>
<td>R (уместность)</td>
<td align="center">Ограничение: 12 часов на каждого участника команды</td>
<td align="right">+ или -</td>
</tr>
<tr>
<td>Т (ограниченность во времени)</td>
...
<td align="right">80 мин * 5 (5 собраний)</td>
<td></td>
</tr>
<tr>
<td>АД (Мастер)</td>
...
<td align="center">Интегрирует с помощью кода готовое ПО в среду гипермаркета, по необходимости дописывает процедуры и функции для успешного внедрения ПО в систему</td>
<td align="right">110 мин</td>
<td></td>
</tr>
<tr>
...
<p><img src="https://user-images.githubusercontent.com/90955398/196729719-6cd9d4ba-5892-4ad5-bcfa-9af9182c0dbf.png" alt="image"></p>
